...
public class DashboardView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(widthSize < DensityUtil.dip2px(minWidthDP,getContext())||heightSize < DensityUtil.dip2px(minHeightDP,getContext())){
            widthSize = DensityUtil.dip2px(minWidthDP,getContext());
            heightSize = DensityUtil.dip2px(minHeightDP,getContext());
        }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        widthDash = DensityUtil.dip2px(50, getContext());
